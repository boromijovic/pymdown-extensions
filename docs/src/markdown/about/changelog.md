...
- **NEW**: SaneHeaders: add new extension which restricts hash headers to only evaluate if the hashes (`#`) are followed
  by a space. Allows extensions like MagicLink to have issues links at the start of a line.
